  ...
  return(
    <div className='flex flex-col gap-4 rounded-lg bg-violet-50 px-4 py-5'>
          <div className='space-y-1'>
            ...
            <p className='text-sm/5 text-violet-500'>You team has used 80% of you available space. Need more?</p>
          </div>
          ...
          <div className='space-x-3'>
            ...
            <button type='button' className='text-sm font-medium text-violet-700 hover:text-violet-900'>Upgrade</button>
